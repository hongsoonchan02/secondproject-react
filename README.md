...
| 이름 | 역할 | 기능 구현 |
|------|------|------|
| 홍순찬 ([hongsoonchan02](https://github.com/hongsoonchan02)) | 팀장 | 부서 관리 기능 구현 |
| 고은별 ([KoreaNirsa](https://github.com/채워주세요)) | 팀원 | 직원 관리 기능 구현 |
| 이소정 ([BeanCan0235](https://github.com/BeanCan0235)) | 팀원 | 로그인 & 비밀번호 찾기 & 대시보드 기능 구현 |
| 임수현 ([soo97](https://github.com/soo97)) | 팀원 | 근태 관리 & 휴가 관리 기능 구현 |
